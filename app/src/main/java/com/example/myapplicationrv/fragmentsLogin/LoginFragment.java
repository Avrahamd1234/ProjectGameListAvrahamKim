...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonLogin = view.findViewById(R.id.loginButtonFragmentLogin);
        ...
        Button buttonAbout = view.findViewById(R.id.aboutButtonFragmentLogin);
        ...
        Button buttonEula = view.findViewById(R.id.eulaButtonFragmentLogin);
        buttonEula.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_loginFragment_to_EULAFragment);
            }
        });
